...
const CommentForm = ({ url, commentType, projectId, commentId, parentId, user, addParent, addReply, editComment, guest, onCancelClick, editorValue, setEditorValue, editMode, replyMode, setActiveEdit, setActiveReply, setEditMode, setReplyMode, }) => {
